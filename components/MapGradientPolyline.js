...
var MapGradientPolyline = React.createClass({
  ...
  propTypes: {
    ...
    /**
     * An array of colors to describe the gradient colors
     */
...
var AIRMapGradientPolyline = requireNativeComponent('AIRMapGradientPolyline', MapGradientPolyline);

module.exports = MapGradientPolyline;
