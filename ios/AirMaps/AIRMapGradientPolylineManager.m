...
#import "AIRMapGradientPolylineManager.h"
...
@interface AIRMapGradientPolylineManager()

@end

@implementation AIRMapGradientPolylineManager

RCT_EXPORT_MODULE()

- (UIView *)view
{
    AIRMapGradientPolyline *polyline = [AIRMapGradientPolyline new];
    return polyline;
}
